...
import { Scale, ShieldCheck, Mail, Globe, Menu, X, ArrowLeft } from "lucide-react";
    ...
    <div className={`lf relative min-h-screen overflow-x-clip bg-[#0b0f1d] text-slate-200 ${HATCH}`}>
      ...
      <main className="container max-w-4xl mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="mb-10 text-center sm:text-left">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-white">Terms of Service</h1>
