  ...
  return (
    <Dialog open onOpenChange={(v) => { if (!v) onClose?.(); }}>
      <DialogContent className="max-w-lg">
        ...
        {/* DialogContent pads nothing - the header and footer pad themselves, so
            a body dropped straight in sits flush against the edges. Same p-5
            body wrapper the other dialogs use, and the scroll lives here rather
            than on the dialog so the footer buttons stay put on a long list. */}
