      ...
      <main className="container max-w-4xl mx-auto px-4 py-16 sm:py-24">
        ...
        <div className="mb-10 text-center sm:text-left">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-3.5 py-1.5 text-xs font-semibold text-foreground/70 shadow-sm mb-4">
            <ShieldAlert className="h-3.5 w-3.5 text-primary" /> Compliance Guidelines
          </span>
          <h1 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-foreground">CAN-SPAM Policy</h1>
          ...
          <section className="space-y-3">
            ...
            <div className="grid gap-4 mt-4 grid-cols-1 sm:grid-cols-2">
              <div className="border border-border p-4 rounded-xl bg-muted/10">
                <h3 className="font-bold text-foreground text-sm">Don't Use Deceptive Headers</h3>
              ...
              <div className="border border-border p-4 rounded-xl bg-muted/10">
                <h3 className="font-bold text-foreground text-sm">Don't Use Misleading Subjects</h3>
              ...
              <div className="border border-border p-4 rounded-xl bg-muted/10">
                <h3 className="font-bold text-foreground text-sm">Include Your Physical Address</h3>
              ...
              <div className="border border-border p-4 rounded-xl bg-muted/10">
                <h3 className="font-bold text-foreground text-sm">Provide a Clear Opt-Out</h3>
